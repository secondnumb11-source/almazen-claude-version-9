...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { k: 'services:المصروفات', label: 'المصروفات', icon: '📤', roles: 'finance', keywords: 'مصروفات كهرباء صيانة قرطاسية' },
      { k: 'services:مصاريف المشروعات', label: 'مصاريف المشروعات', icon: '🏗️', roles: 'finance', keywords: 'مشروعات عدد أدوات ملابس' },
    ],
  },
  {
